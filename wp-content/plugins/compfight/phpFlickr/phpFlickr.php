...
if ( !class_exists('phpFlickr') ) {
	...
	class phpFlickr {
        ...
        // Start Transient Cache
				$this->cache = 'ts';
				$this->cache_dir = 'cf_cache_';
        // End Transient Cache
			} elseif ( $type == 'custom' ) {
				$this->cache = "custom";
		...
		function getCached ($request)
		{
			...
			} elseif ($this->cache == 'ts') {
        // Transient Cache
        $transient_name = $this->cache_dir . $reqhash;
				return $transient = get_transient($transient_name);
        // End Transient Cache
        ...
        // Transient Cache
        $transient_name = $this->cache_dir . $reqhash;
        $transient = set_transient($transient_name, $response, $this->cache_expire);
        // End Transient Cache
				return $transient;
			} elseif ( $this->cache == "custom" ) {
